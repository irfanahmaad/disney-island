...
export default function SampleIsland({
  billboards = [],
  active = false,
  ...props
}) {
  const group = useRef()
  const { nodes, materials } = useGLTF('/3D/disney-island-compressed.glb')
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      ...
      <group
        position={[0.01, 0.07, -0.43]}
        rotation={[0, -0.89, 0]}
        userData={{ name: 'island 1 active' }}
        visible={active}
      >
        <mesh
      ...
      <group
        position={[0.01, 0.07, -0.43]}
        rotation={[0, -0.89, 0]}
        userData={{ name: 'island 1 inactive.001' }}
        visible={!active}
      >
        <mesh
...
useGLTF.preload('/3D/disney-island-compressed.glb')

...
export default function SampleIsland({ ...props }) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/3D/sample-island.glb')
  const { actions } = useAnimations(animations, group)

  return (
    <group ref={group} {...props} dispose={null}>
      <group scale={1} position={[0, 0, 0]}>
        <group name='Empty' position={[0, 0, 0]} />
        <group name='null003' position={[0, 0, 0]}>
          <mesh
